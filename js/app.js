...
},{"../heart":38}],2:[function(require,module,exports){
...
},{"./Scheduler":13,"./async":15,"./makePromise":25}],12:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./Queue":12}],14:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../TimeoutError":14,"../timer":26}],23:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../timer":26}],24:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./when":28}],28:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
...
},{"./Label":32,"./User":35,"./github":37,"knockout":8,"lodash":9}],30:[function(require,module,exports){
var _ = require('lodash');
var when = require('when');
var github = require('./github');
...
},{"./github":37,"./log":41,"lodash":9,"when":28}],31:[function(require,module,exports){
var ko = require('knockout');
var _ = require('lodash');
...
},{"./Issue":29,"./log":41,"knockout":8,"lodash":9}],32:[function(require,module,exports){
var ko = require('knockout');
var _ = require('lodash');
...
},{"knockout":8,"lodash":9}],33:[function(require,module,exports){
var ko = require('knockout');
var _ = require('lodash');
...
},{"./Issue":29,"./log":41,"knockout":8,"lodash":9}],34:[function(require,module,exports){
var ko = require('knockout');
var _ = require('lodash');
var when = require('when');
...
},{"./IssuePriority":30,"./IssueView":31,"./Milestone":33,"./github":37,"./log":41,"knockout":8,"lodash":9,"when":28,"when/sequence":27}],35:[function(require,module,exports){
var ko = require('knockout');
var _ = require('lodash');
...
},{"knockout":8,"lodash":9}],36:[function(require,module,exports){
...
_.extend(CredentialsDialog.prototype, {
    template: "<div class=\"modal-bg\" data-bind=\"css: {'in': visible}\">\n    <div class=\"modal\">\n        <h2>Your Github Credentials</h2>\n\n        <ul class=\"form-list\">\n            <li class=\"form-list__item\" data-bind=\"css: {error: tokenError}\">\n                <label class=\"clearfix\" for=\"api-token\">\n                    <span>API Token</span>\n                    <a href=\"https://github.com/blog/1509-personal-api-tokens\" target=\"_blank\" title=\"Learn about github personal API tokens\" class=\"icon-button right\">\n                        <span class=\"fa fa-question-circle\"></span>\n                    </a>\n                </label>\n                <input id=\"api-token\" name=\"api-token\" type=\"text\" class=\"text-input\" data-bind=\"value: token\">\n                <small class=\"error-message\">\n                   Oh, brudda. This API token is invalid.\n                </small>\n            </li>\n\n            <li class=\"form-list__item\" data-bind=\"css: {error: repoError}\">\n                <label for=\"repo\">Repo</label>\n                <input id=\"repo\" name=\"repo\" type=\"text\" class=\"text-input\" placeholder=\"username/repo\" data-bind=\"value: repo\">\n                <small class=\"error-message\">\n                   That repo doesn&rsquo;t exist on this astral plane!\n                </small>\n            </li>\n\n            <li class=\"form-list__item\">\n                <label for=\"repo\">Data Branch (optional)</label>\n                <input id=\"repo\" name=\"repo\" type=\"text\" class=\"text-input\" placeholder=\"your-branch-name\" data-bind=\"value: branch, valueUpdate: 'input'\">\n                <!-- ko if: showBranchInstructions -->\n                <small class=\"helper-message\">\n                    If you want the order of your issues to be remembered, run these commands in your terminal:\n                    <pre>\n                        <span class=\"make-block\">git checkout --orphan <span data-bind=\"text: branch\"></span></span>\n                        <span class=\"make-block\">git rm -rf .</span>\n                        <span class=\"make-block\">echo \"A branch for githeartissues data\" > README.md</span>\n                        <span class=\"make-block\">git add README.md</span>\n                        <span class=\"make-block\">git commit -am \"Setting up githeartissues branch\"</span>\n                        <span class=\"make-block\">git push origin <span data-bind=\"text: branch\"></span></span>\n                    </pre>\n                </small>\n                <!-- /ko -->\n            </li>\n            <li class=\"form-list__item\">\n                <button type=\"submit\" class=\"btn full-width\" data-bind=\"click: close\">Donezo</button>\n            </li>\n        </ul>\n    </div>\n</div>\n",
    open: function() {
...
},{"../github":37,"../log":41,"knockout":8,"lodash":9,"when":28}],37:[function(require,module,exports){
var _ = require('lodash');
...
},{"./requests":42,"lodash":9}],38:[function(require,module,exports){
...
},{"./IssueView":31,"./MilestoneView":34,"./User":35,"./credentials/CredentialsDialog":36,"./github":37,"./lib/knockout-sortable":39,"./lib/knockout-string-template":40,"./log":41,"knockout":8,"lodash":9,"when":28,"when/sequence":27}],39:[function(require,module,exports){
...
},{"jquery":7,"jquery-ui/sortable":5,"knockout":8}],40:[function(require,module,exports){
/**
...
},{"knockout":8}],41:[function(require,module,exports){
var _ = require('lodash');
...
},{"lodash":9,"moment":10}],42:[function(require,module,exports){
var when = require('when');
var _ = require('lodash');
