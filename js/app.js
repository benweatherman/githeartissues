...
},{"./Scheduler":11,"./async":13,"./makePromise":23}],10:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./Queue":10}],12:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"FWaASH":1}],14:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../TimeoutError":12,"../timer":24}],21:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../timer":24}],22:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./when":26}],26:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
...
},{"./lib/Promise":9,"./lib/TimeoutError":12,"./lib/decorators/array":14,"./lib/decorators/flow":15,"./lib/decorators/fold":16,"./lib/decorators/inspect":17,"./lib/decorators/iterate":18,"./lib/decorators/progress":19,"./lib/decorators/timed":20,"./lib/decorators/unhandledRejection":21,"./lib/decorators/with":22}],27:[function(require,module,exports){
var Heart = require('../heart');

var heart = window['♥'] = new Heart();
heart.start(document.querySelector('body'));

},{"../heart":36}],28:[function(require,module,exports){
...
},{"./User":33,"./github":35,"knockout":7,"lodash":8}],29:[function(require,module,exports){
var _ = require('lodash');
var when = require('when');
var github = require('./github');
...
},{"./github":35,"./log":39,"lodash":8,"when":26}],30:[function(require,module,exports){
var ko = require('knockout');
var _ = require('lodash');
...
},{"./Issue":28,"./log":39,"knockout":7,"lodash":8}],31:[function(require,module,exports){
var ko = require('knockout');
var _ = require('lodash');
var github = require('./github');
...
},{"./Issue":28,"./github":35,"./log":39,"knockout":7,"lodash":8}],32:[function(require,module,exports){
var ko = require('knockout');
var _ = require('lodash');
...
},{"./IssuePriority":29,"./IssueView":30,"./Milestone":31,"./log":39,"knockout":7,"lodash":8}],33:[function(require,module,exports){
var ko = require('knockout');
var _ = require('lodash');
...
},{"knockout":7,"lodash":8}],34:[function(require,module,exports){
...
_.extend(CredentialsDialog.prototype, {
    template: "<div class=\"modal-bg\" data-bind=\"css: {'in': visible}\">\n    <div class=\"modal\">\n        <h2>Your Github Credentials</h2>\n\n        <ul class=\"form-list\">\n            <li class=\"form-list-item\">\n                <label for=\"api-key\">API Key</label>\n                <input id=\"api-key\" name=\"api-key\" type=\"text\" class=\"text-input\" data-bind=\"value: token\">\n            </li>\n            <li class=\"form-list-item\">\n                <label for=\"repo\">Repo</label>\n                <input id=\"repo\" name=\"repo\" type=\"text\" class=\"text-input\" placeholder=\"username/repo\" data-bind=\"value: repo\">\n            </li>\n            <li class=\"form-list-item\">\n                <label for=\"repo\">Data Branch</label>\n                <input id=\"repo\" name=\"repo\" type=\"text\" class=\"text-input\" placeholder=\"githeartissues\" data-bind=\"value: branch, valueUpdate: 'input'\">\n                <!-- ko ifnot: branchExists -->\n                <small>\n                    You need to create this via the commandline with\n                    <pre>\ngit checkout --orphan <span data-bind=\"text: branch\"></span>\ngit rm -rf .\necho \"A branch for storing githeartissues data\" > README.md\ngit add README.md\ngit commit -am \"Setting up githeartissues data branch\"\ngit push origin <span data-bind=\"text: branch\"></span>\n                    </pre>\n                </small>\n                <!-- /ko -->\n            </li>\n            <li class=\"form-list-item\">\n                <button type=\"submit\" class=\"button submit-button fatty\" data-bind=\"click: close\">Donezo</button>\n            </li>\n        </ul>\n    </div>\n</div>\n",
    open: function() {
...
},{"../github":35,"../log":39,"knockout":7,"lodash":8,"when":26}],35:[function(require,module,exports){
var _ = require('lodash');
...
},{"./requests":40,"lodash":8}],36:[function(require,module,exports){
...
},{"./IssueView":30,"./MilestoneView":32,"./User":33,"./credentials/CredentialsDialog":34,"./github":35,"./lib/knockout-sortable":37,"./lib/knockout-string-template":38,"./log":39,"knockout":7,"lodash":8,"when":26,"when/sequence":25}],37:[function(require,module,exports){
...
},{"jquery":6,"jquery-ui/sortable":4,"knockout":7}],38:[function(require,module,exports){
/**
...
},{"knockout":7}],39:[function(require,module,exports){
var log = console || {
